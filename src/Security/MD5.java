...
public class MD5 {
	...
	public static String lowercaseMD5(String str) {
		try {
			...
			// digest() return MD5 hash value(Octal byte), but actually MD hash value should be hexadecimal byte
			// hexadecimal
	...
	public static void main(String[] args) {
		String lowercaseMd = lowercaseMD5("password");
		System.out.println("lowercaseMd: " + lowercaseMd);
		String uppercaseMd = uppercaseMD5("password");
		System.out.println("uppercaseMd: " + uppercaseMd);
	}
}
